...
function BannerItem({ image, lcp }: { image: Banner; lcp?: boolean }) {
  ...
  return (
    <a
      ...
      class="relative h-[363px] overflow-y-hidden w-full"
    >
      <Picture preload={lcp}>
        <Source
      ...
      {action && (
        <div class="hidden absolute top-0 bottom-0 m-auto left-0 right-0 sm:right-auto sm:left-[12%] max-h-min max-w-[235px] flex-col gap-4 p-4 rounded glass">
...
function BannerCarousel({ images, preload, interval }: Props) {
  ...
  return (
    <div class="flex items-center justify-center w-full h-full">
      <div
        id={id}
        class="max-w-[1180px] container px-2 lg:px-0 grid grid-cols-[48px_1fr_48px] sm:grid-cols-[120px_1fr_120px] grid-rows-[1fr_48px_1fr_64px]"
      >
